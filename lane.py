...
class Lane:
    ...
    def setupObstacle(self):
        ...
        if self.lane_type == "street":
            ...
            image_directory = f"Tastatur/images/{self.lane_type}/{self.direction}/{car}.png"
            ...
            if self.direction == "left":
                left, middle, right = f"Tastatur/images/{self.lane_type}/{self.direction}/turtle.png", f"Tastatur/images/{self.lane_type}/{self.direction}/turtle.png", f"Tastatur/images/{self.lane_type}/{self.direction}/turtle.png"
            elif self.direction == "right":
                left, middle, right = f"Tastatur/images/{self.lane_type}/{self.direction}/left.png", f"Tastatur/images/{self.lane_type}/{self.direction}/middle.png", f"Tastatur/images/{self.lane_type}/{self.direction}/right.png"
